...
from core.constants import (LOOKUP_TABLE_DEFINITION_OFFSET,
                            LOOKUP_TABLE_SIZE_DEFINITION_OFFSET, MAGIC_BYTES,
                            STRINGLITERAL_DATA_DEFINITION_OFFSET,
                            STRINGLITERAL_DATA_SIZE_DEFINITION_OFFSET)
